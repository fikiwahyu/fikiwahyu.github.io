  ...
  const app = Vue.createApp({
    ...
    data() {
      return {
        ...
        notifications: ["This is the notification"],
        ...
        skillsItems: [
          {
            imgUrl: "assets/images/logo/html5.png",
            title: "HTML5",
          },
          {
            imgUrl: "assets/images/logo/css3.png",
            title: "CSS3",
          },
          {
            imgUrl: "assets/images/logo/javascript.png",
            title: "JavaScript",
          },
          {
            imgUrl: "assets/images/logo/php.png",
            title: "PHP8+",
          },
          {
            imgUrl: "assets/images/logo/python.png",
            title: "Python",
          },
          {
            imgUrl: "assets/images/logo/vue.png",
            title: "Vue",
          },
          {
            imgUrl: "assets/images/logo/bootstrap5.png",
            title: "Bootstrap",
          },
        ],
        ...
        toolsItems: [
          {
            imgUrl: "assets/images/logo/jQuery.png",
            title: "Ajax",
          },
          {
            imgUrl: "assets/images/logo/github.png",
            title: "Git (Github)",
          },
          {
          ...
          {
            imgUrl: "assets/images/logo/vscode.png",
            title: "VS Code",
          },
          {
            imgUrl: "assets/images/logo/blogger.png",
            title: "Blogger",
          },
          {
            imgUrl: "assets/images/logo/wordpress.png",
            title: "Wordpress",
          },
          {
            imgUrl: "assets/images/logo/jira.png",
            title: "Jira",
          },
          {
            imgUrl: "assets/images/logo/slack.png",
            title: "Slack",
          },
        ],
        ...
        experienceItems: [
          {
            ...
            desc: {
              en: "This is the first time i learn about programming, in this phase i recognize that i am into programming and having a big interrest when i was junior high school student. my first assignment is to make a simple website using HTML 😄",
            },
          },
          {
            date: "2020",
            ...
            jobTitle: {
              en: "Front-End Developer & Content Creator",
            },
            desc: {
              en: "Maintaining technical aspects of the front-end especially landing page and giving information about the college's events.",
            },
          },
          {
            date: "2020",
            ...
            desc: {
              en: "doing Backend and Frontend to the blog based on XML Programming by using Blogger Framework. the subject that i write is the thing that i learnt before (mostly about engineering and some random stuff written in indonesia), because i want to give a trusted information that can be used by my knowledge",
            },
          },
          {
            date: "2021",
            ...
            desc: {
              en: "Make a system based on PHP that. Coverbook.id is an educational platform that prepare a tryout for UTBK and College selection Test. We also prepare a function that can analyze our student's progress. coverbook.id has been applied the latest scoring system for our tryout.",
            },
          },
          {
            date: "2022",
            ...
            jobTitle: {
              en: "Web Developer & Data Science",
            },
            desc: {
              en: "Nextdev Digitalent Academy is an scholarship proggram presented by Telkomsel the biggest internet provider in indonesia colaborated by Hacktiv8 bootcamp. in this scholarship we learnt about the fundamental of web development program and data science to be applied on the real project as the final assignment",
            },
          },
          {},
          {},
        ...
        filters: ["All", "Blogger", "HTML", "Vue", "PHP"],
        currentFilter: "All",
    ...
    methods: {
      getInstagramPost() {
        fetch(
          ...
          .then((response) => {
            let instaPost = [];
            let instagramPostItems = document.querySelector(
              ".instagram-post-items"
            );
            let postItems = instagramPostItems.querySelectorAll(
              ".instagram-post-item"
            );
            ...
            postItems.forEach((e, i) => {
              if (instaPost[i].media_type == "VIDEO") {
                e.querySelector(".instagram-pict").src =
                  instaPost[i].thumbnail_url;
              } else {
                e.querySelector(".instagram-pict").src = instaPost[i].media_url;
              }
              e.querySelector(".instagram-caption").textContent =
                instaPost[i].caption;
    ...
    computed: {
      ...
      // get the total project handled
      projectHandled() {
        return this.experienceItems.length;
      },
      // get the total client handled
      clientsHandled() {
